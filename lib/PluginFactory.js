...
var InstallerPlugin = require('./PluginState/InstallerPlugin');
var InjectorPlugin = require('./PluginState/InjectablePlugin');
var NonePlugin = require('./PluginState/NonePlugin');
/**
...
module.exports = function(Dependencies, Shared){
  ...
  var plugins = _.chain(rawplugins)
    .map(function(plugin) {
      ...
      return new pickPluginType(plugin, instanceObjects)
...
function pickPluginType(plugin, shared){
  switch (plugin.getType()) {
    case 'none':
      return new NonePlugin(plugin, shared)
      break;
    case 'installer':
      return new InstallerPlugin(plugin, shared);
      break;
    default:
