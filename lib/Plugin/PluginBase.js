...
function PluginBase(RawPlugin, pluginOptions, Shared) {
  ...
  this.applicationDirectoryPath = Shared.FrameworkOptions.applicationDirectory;
  ...
  this.computedOptions = this._computeConfig(pluginOptions, Shared.FrameworkOptions.pluginSettings);
}
...
PluginBase.prototype._getExternalOptions = function(pluginOptions, pluginSettings){
  var self = this;
  var ExternalOptions;
...
PluginBase.prototype._computeConfig = function(pluginOptions, pluginSettings){
  var external = this._getExternalOptions(pluginOptions, pluginSettings);
  if(this.options) {
    var config;
    ...
    if(workDir) {
      var absoluteWorkdir = path.join(this.applicationDirectoryPath, workDir);
      try {
...
PluginBase.prototype._generateConfigName = function(){
  //_.upperFirst(_.camelCase(_.replace('pomegranate-test-module', 'pomegranate', '')))
