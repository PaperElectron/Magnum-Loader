...
PluginIterator.prototype.load = function() {
  ...
  return this._install()
    .then(function() {
      return self._processLayers(layers, 'load', null, loadFinished)
    })
...
PluginIterator.prototype.start = function() {
  ...
  return this._processLayers(layers, 'start', null, startFinished)
}
...
PluginIterator.prototype.stop = function() {
  ...
  return this._processLayers(reverselayers, 'stop', null, stopFinished)
}
