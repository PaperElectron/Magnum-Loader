...
Plugin.prototype.load = function() {
  ...
  return new Promise(function(resolve, reject) {
    ...
    return self.hooks.load.apply(self.context, [self.Injector.inject, function(err, toInject) {
      ...
      if(self.loaded){
        return reject(new self.FrameworkErrors.PluginHookError('Hook already called on this plugin', self.humanName, 'load'))
      }
...
Plugin.prototype.start = function() {
  ...
  return new Promise(function(resolve, reject) {
    ...
    return self.hooks.start.apply(self.context, [function(err) {
      ...
      if(self.started){
        return reject(new self.FrameworkErrors.PluginHookError('Hook already called on this plugin', self.humanName, 'start'))
      }
...
Plugin.prototype.stop = function() {
  ...
  return new Promise(function(resolve, reject) {
    ...
    return self.hooks.stop.apply(self.context, [function(err) {
      ...
      if(self.stopped){
        return reject(new self.FrameworkErrors.PluginHookError('Hook already called on this plugin', self.humanName, 'stop'))
      }
