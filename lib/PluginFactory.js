...
var InjectableState = require('./PluginState/PluginStates/InjectablePlugin');
/**
...
module.exports = function(Dependencies, Shared){
  ...
  var plugins = _.chain(rawplugins)
    .map(function(plugin) {
      ...
      var instantiatedPlugin = new Plugin(plugin, instanceObjects);
      return new InjectableState(instantiatedPlugin)
