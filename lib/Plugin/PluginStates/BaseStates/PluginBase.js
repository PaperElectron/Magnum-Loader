...
function PluginBase(RawPlugin, FrameworkInjector, DependencyInjector) {
  ...
  this.FrameworkCommandMode = FrameworkInjector.get('Options').commandMode;
...
PluginBase.prototype.isEnabled = function(){
  if(this.FrameworkCommandMode) {
    if(!this.enabled) {
      this.FrameworkLogger.warn(`Warning! ${this.moduleName} is currently disabled by config file.`)
    }
    return true
  }
  return this.enabled
